...
wget -q -O shadowsocks2022 "https://{GITHUB}/menu/shadowsocks2022.sh"
wget -q -O socks "https://{GITHUB}/menu/socks.sh"
...
wget -q -O add-ss "https://{GITHUB}/shadowsocks/add-ss.sh"
wget -q -O del-ss "https://{GITHUB}/shadowsocks/del-ss.sh"
wget -q -O extend-ss "https://{GITHUB}/shadowsocks/extend-ss.sh"
wget -q -O trialss "https://{GITHUB}/shadowsocks/trialss.sh"
wget -q -O cek-ss "https://{GITHUB}/shadowsocks/cek-ss.sh"
sleep 0.5
echo -e "${GB}[ INFO ]${NC} ${YB}Downloading Menu Shadowsocks 2022${NC}"
wget -q -O add-ss2022 "https://{GITHUB}/shadowsocks2022/add-ss2022.sh"
wget -q -O del-ss2022 "https://{GITHUB}/shadowsocks2022/del-ss2022.sh"
wget -q -O extend-ss2022 "https://{GITHUB}/shadowsocks2022/extend-ss2022.sh"
wget -q -O trialss2022 "https://{GITHUB}/shadowsocks2022/trialss2022.sh"
wget -q -O cek-ss2022 "https://{GITHUB}/shadowsocks2022/cek-ss2022.sh"
sleep 0.5
echo -e "${GB}[ INFO ]${NC} ${YB}Downloading Menu Socks5${NC}"
wget -q -O add-socks "https://{GITHUB}/socks/add-socks.sh"
wget -q -O del-socks "https://{GITHUB}/socks/del-socks.sh"
wget -q -O extend-socks "https://{GITHUB}/socks/extend-socks.sh"
wget -q -O trialsocks "https://{GITHUB}/socks/trialsocks.sh"
wget -q -O cek-socks "https://{GITHUB}/socks/cek-socks.sh"
sleep 0.5
...
wget -q -O log-socks "https://{GITHUB}/log/log-socks.sh"
...
wget -q -O xraymod "https://{GITHUB}/other/xraymod.sh"
wget -q -O xrayofficial "https://{GITHUB}/other/xrayofficial.sh"
